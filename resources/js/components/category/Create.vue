      ...
      <div class="card border-lg-top-success card radius-15">
        <div class="card-body p-5">
          <div class="card-title d-flex align-items-center">
            <div>
              <i class="bx bxs-food-menu mr-1 font-24 text-success"></i>
            </div>
            <h4 class="mb-0 text-success">Category Add</h4>
          </div>
          <hr />
          <form action="" @submit.prevent="insertCategory" enctype="multipart/form-data">
            <div class="form-body">
              <div class="form-row">
              ...
              <button type="submit" class="btn btn-success px-5 float-right">Add</button>
            </div>
          </form>
        </div>
      </div>
