<template>
  <div>
    <div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
          ...
          <ol class="breadcrumb mb-0 p-0">
            <li class="breadcrumb-item">
              <a href="javascript:;" class="text-success"
                ><i class="bx bx-money"></i>Salary</a
              >
            </li>
      ...
      <div class="ml-auto">
        <div class="btn-group">
          <router-link class="btn btn-success" to="/given-salary"
            >Given salary</router-link
          >
        </div>
      </div>
    </div>
      ...
      <div class="card border-lg-top-success card radius-15">
        <div class="card-body p-5">
          <div class="card-title d-flex align-items-center">
            ...
            <h4 class="mb-0 text-success">Pay to employee salary</h4>
          </div>
          <hr />
          <form action="" @submit.prevent="salaryPay">
            <div class="form-body">
              <div class="form-row">
